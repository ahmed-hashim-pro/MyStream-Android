...
public class PlayerControlsDemoActivity extends YouTubeFailureRecoveryActivity implements
    ...
    private static final ListEntry[] ENTRIES = {
            new ListEntry("Androidify App", "5eD3LkhcHss", false),
            new ListEntry("Chrome Speed Tests", "5eD3LkhcHss", false),
            new ListEntry("Playlist: Google I/O 2012", "RDiOxzG3jjFkY", true)};
