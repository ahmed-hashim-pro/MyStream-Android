...
public class QuranDownloadNotifier {
  ...
  public static class ProgressIntent {
    public static final String INTENT_NAME =
        "com.medoapps.www.onlinequran.download.ProgressUpdate";
  ...
  private void showNotification(String titleString,
    ...
    PendingIntent contentIntent = PendingIntent.getActivity(appContext, 0, notificationIntent, PendingIntent.FLAG_IMMUTABLE);
