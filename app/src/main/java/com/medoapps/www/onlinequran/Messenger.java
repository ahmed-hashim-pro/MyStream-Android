...
import com.medoapps.www.onlinequran.ui.FriendsFragment;
import com.medoapps.www.onlinequran.ui.GroupFragment;
import com.medoapps.www.onlinequran.ui.LoginActivity;
import com.medoapps.www.onlinequran.ui.UserProfileFragment;
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ServiceUtils.stopServiceFriendChat(Messenger.this.getApplicationContext(), false);
                if (adapter.getItem(position) instanceof FriendsFragment) {
                    floatButton.setVisibility(View.VISIBLE);
                    floatButton.setOnClickListener(((FriendsFragment) adapter.getItem(position)).onClickFloatButton.getInstance(Messenger.this));
                    floatButton.setImageResource(R.drawable.plus);
                } else if (adapter.getItem(position) instanceof GroupFragment) {
                    floatButton.setVisibility(View.VISIBLE);
                    floatButton.setOnClickListener(((GroupFragment) adapter.getItem(position)).onClickFloatButton.getInstance(Messenger.this));
