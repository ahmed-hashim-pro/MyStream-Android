...
import com.medoapps.www.onlinequran.hashimyoutubeplayer.ui.FlippingView;
import com.medoapps.www.onlinequran.hashimyoutubeplayer.ui.ImageWallView;
...
public class VideoWallDemoActivity extends Activity implements
    ...
    private static final String PLAYLIST_ID = "RDiOxzG3jjFkY";
//    private static final String PLAYLIST_ID = "ECAE6B03CA849AD332";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        int maxAllowedNumberOfRows2 = (int) Math.floor(
                (displayMetrics.heightPixels / displayMetrics.density) / PLAYER_VIEW_MINIMUM_HEIGHT_DP);

        int maxAllowedNumberOfRows = 50;


        int numberOfRows2 = Math.min(maxAllowedNumberOfRows, MAX_NUMBER_OF_ROWS_WANTED);
        int numberOfRows = 40;
        int interImagePaddingPx = (int) displayMetrics.density * INTER_IMAGE_PADDING_DP;
        int imageHeight2 = (displayMetrics.heightPixels / numberOfRows) - interImagePaddingPx;
        int imageHeight = 200;
        int imageWidth2 = (int) (imageHeight * THUMBNAIL_ASPECT_RATIO);
        int imageWidth = 200;
