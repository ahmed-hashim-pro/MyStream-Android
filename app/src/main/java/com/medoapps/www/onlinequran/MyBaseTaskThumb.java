 ...
 * count is zero.
 */
public abstract class MyBaseTaskThumb extends Service {

    private static final String CHANNEL_ID_DEFAULT = "default";

    static final int PROGRESS_NOTIFICATION_ID = 5;
    static final int FINISHED_NOTIFICATION_ID = 6;

    private static final String TAG = "MyBaseTaskThumb";
